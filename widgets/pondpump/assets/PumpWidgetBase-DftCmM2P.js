...
`;function j(){if(typeof document>"u"||document.getElementById("pp-pump-styles"))return;const n=document.createElement("style");n.id="pp-pump-styles",n.appendChild(document.createTextNode(M)),document.head.appendChild(n)}function $(n){const t=typeof window<"u"&&window.systemLang||"en",e=b[t],o=b.en;return(e==null?void 0:e[n])||(o==null?void 0:o[n])||n}const g="pondpump";function m(n){return((n==null?void 0:n.instance)!==void 0&&n.instance!==""?String(n.instance):"0").split(".").pop()||"0"}function C(n){const t=n==null?void 0:n.pumpId;return t?`${g}.${m(n)}.pumps.${t}`:""}function O(n){const t=n==null?void 0:n.name;if(typeof t=="string")return t;if(t&&typeof t=="object"){const e=t;return e.en||Object.values(e)[0]||""}return""}async function F(n,t){try{const e=await n.getObject(t);return O((e==null?void 0:e.common)||{})}catch{return""}}async function N(n,t){const e=`${g}.${t}.pumps.`,o=`${e}香`;let s={};try{if(typeof n.getObjectViewSystem=="function")s=await n.getObjectViewSystem("device",e,o)||{};else if(typeof n.getObjectView=="function"){const c=await n.getObjectView("system","device",{startkey:e,endkey:o});for(const a of(c==null?void 0:c.rows)||[])s[a.id]=a.value}}catch{return[]}const r=[];for(const[c,a]of Object.entries(s)){if(!c.startsWith(e))continue;const l=c.substring(e.length);if(!l||l.includes("."))continue;const i=(a==null?void 0:a.common)||{};let p="";typeof i.name=="string"?p=i.name:i.name&&typeof i.name=="object"&&(p=i.name.en||Object.values(i.name)[0]||""),r.push({id:l,name:p.trim()||l})}return r.sort((c,a)=>c.name.localeCompare(a.name)),r}function D(n){const{socket:t,data:e,onDataChange:o,label:s}=n,[r,c]=x([]),a=m(e);w(()=>{let i=!0;return N(t,a).then(p=>i&&c(p)),()=>{i=!1}},[t,a]);const l=e.pumpId||"";return v(k,{fullWidth:!0,variant:"standard",size:"small",children:[f(_,{children:s}),f(S,{value:r.some(i=>i.id===l)?l:"",onChange:i=>o({...e,pumpId:i.target.value}),children:r.length?r.map(i=>f(h,{value:i.id,children:i.name},i.id)):f(h,{value:"",disabled:!0,children:"—"})})]})}function G(){return{name:"common",fields:[{name:"instance",type:"instance",label:"pondpump_instance",adapter:g,isShort:!0,default:"0"},{name:"pumpId",type:"custom",label:"pump",component:(n,t,e,o)=>f(D,{socket:o.context.socket,data:t,onDataChange:e,label:n.label||"pump"})}]}}function T(n,t){return n&&n.trim()||`#${t}`}function V(n){if(typeof n!="string"||!n.trim())return new Set;try{const t=JSON.parse(n);return new Set(Array.isArray(t)?t.filter(e=>typeof e=="string"):[])}catch{return new Set}}async function W(n,t,e){var o,s;if(!e)return[];try{const r=await n.getObject(`system.adapter.${g}.${t}`),a=((s=(o=((r==null?void 0:r.native)??{}).schedules)==null?void 0:o[e])==null?void 0:s.plans)??[],l=[];let i=0;for(const p of a){if((p==null?void 0:p.mode)!=="actuator")continue;i+=1;const d=typeof p.target=="string"?p.target:"",u=(typeof p.actuatorName=="string"?p.actuatorName:"").trim()||`Aktor ${i}`,y=typeof p.actuatorIcon=="string"&&p.actuatorIcon?p.actuatorIcon:"⚙️";l.push({key:T(d,i),name:u,icon:y})}return l}catch{return[]}}function q(n){const{socket:t,data:e,onDataChange:o}=n,[s,r]=x([]),c=m(e),a=e.pumpId||"";w(()=>{let p=!0;return W(t,c,a).then(d=>p&&r(d)),()=>{p=!1}},[t,c,a]);const l=V(e.hiddenActuators),i=(p,d)=>{const u=new Set(l);d?u.delete(p):u.add(p),o({...e,hiddenActuators:JSON.stringify([...u])})};return s.length?f(I,{children:s.map(p=>f(P,{control:f(A,{size:"small",checked:!l.has(p.key),onChange:d=>i(p.key,d.target.checked)}),label:`${p.icon} ${p.name}`},p.key))}):f(z,{sx:{fontSize:12,color:"text.secondary"},children:$("no_actuators")})}function J(){return{name:"hiddenActuators",type:"custom",label:"actuators_visibility",component:(n,t,e,o)=>f(q,{socket:o.context.socket,data:t,onDataChange:e})}}class L extends window.visRxWidget{static adapter;subscribedIds=[];ppMounted=!1;tickTimer=null;tickMs=0;rpmAt100=0;applyPartial(t){this.setState(t)}constructor(t){super(t),this.state={...this.state,fv:{},tick:0}}componentDidMount(){super.componentDidMount(),this.ppMounted=!0,j(),this.subscribePump(),this.tickMs>0&&(this.tickTimer=setInterval(()=>this.ppMounted&&this.applyPartial(t=>({tick:t.tick+1})),this.tickMs))}componentWillUnmount(){this.ppMounted=!1,this.tickTimer&&(clearInterval(this.tickTimer),this.tickTimer=null),this.unsubscribePump(),super.componentWillUnmount()}onRxDataChanged(){this.subscribePump()}channel(){return C(this.state.rxData)}pumpIds(){const t=this.channel();return t?this.relIds().map(e=>`${t}.${e}`):[]}async subscribePump(){this.unsubscribePump();const t=this.pumpIds();if(!t.length){this.applyPartial(()=>({fv:{}}));return}this.subscribedIds=t;for(const e of t)try{const o=await this.props.context.socket.getState(e);this.applyState(e,o)}catch{}for(const e of t)try{await this.props.context.socket.subscribeState(e,this.onPumpState)}catch{}}unsubscribePump(){if(this.subscribedIds.length){for(const t of this.subscribedIds)try{this.props.context.socket.unsubscribeState(t,this.onPumpState)}catch{}this.subscribedIds=[]}}onPumpState=(t,e)=>{this.applyState(t,e)};applyState(t,e){if(!this.ppMounted)return;const o=this.channel(),s=o&&t.startsWith(`${o}.`)?t.substring(o.length+1):t;this.applyPartial(r=>({fv:{...r.fv,[s]:e?e.val:null}}))}write(t,e){const o=this.channel();o&&this.props.context.socket.setState(`${o}.${t}`,e,!1)}num(t){const e=this.state.fv[t];return e==null||e===""?null:Number(e)}str(t){const e=this.state.fv[t];return typeof e=="string"?e:""}bool(t){return this.state.fv[t]===!0}sfcActive(){const t=this.state.fv["control.sfc"];if(typeof t=="boolean")return t;const e=this.str("status.fcStatus").trim().toLowerCase();return e!==""&&!e.includes("off")&&!["0","inactive","none","aus","false"].includes(e)}actualSpeedPct(){const t=this.num("control.speed"),e=this.num("telemetry.speed");return!this.sfcActive()&&t!==null&&t>5&&e!==null&&e>0&&(this.rpmAt100=e/(t/100)),e!==null&&this.rpmAt100>0?Math.max(0,Math.min(100,e/this.rpmAt100*100)):t??0}spinDuration(){const t=this.actualSpeedPct(),e=Math.round(Math.max(0,Math.min(100,t))/10)*10;if(e<=0)return 0;const o=5;return Math.round(o*Math.pow(.25/o,e/100)*100)/100}}export{L as P,C as a,J as b,F as c,T as d,V as h,G as p};
